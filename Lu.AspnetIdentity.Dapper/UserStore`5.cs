namespace Lu.AspnetIdentity.Dapper
{
    ...
    public class UserStore<TUser, TRole, TUserRole, TUserLogin, TUserClaim> : UserStore<TUser, TRole, TUserRole, TUserLogin, TUserClaim, string, string, string, string, string>, IUserStore<TUser>
    ...
    {
        public UserStore(DapperIdentityDbContext<TUser, TRole, TUserRole, TUserLogin, TUserClaim> dbContext)
            : base(dbContext)
        {
        }
